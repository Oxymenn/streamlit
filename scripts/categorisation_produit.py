...
def find_similarities(text1, text2, vectorizers):
    ...
    return sum(similarities) / len(similarities)  # Moyenne des similarités
            ...
            if st.button("Catégoriser les produits"):
                ...
                for i, row in df_primary.iterrows():
                    ...
                    for collection, cleaned_collection in zip(collections, cleaned_collections):
                        similarity = find_similarities(combined_text, cleaned_collection, vectorizers)
